...
export const MARKET_VENDORS: readonly MarketVendor[] = [
  ...
  { id: 'curios', name: 'Staffing Company', keeper: 'Wren', tagline: 'Your wandering roster', greeting: 'Everyone here is already on your side. Take your pick.', accent: 0xa7b4eb }
];

export const MARKET_ITEMS: readonly MarketItem[] = [
  { id: 'unlock-crossbow', vendorId: 'forge', kind: 'weapon', name: 'Heartwood Crossbow', description: 'A new arm for any wanderer. Bolts pierce through enemies.', effect: 'Permanent weapon unlock.', prices: [15], maxRank: 1, icon: 'blade', accent: 0xef9d64 },
  ...
  { id: 'unlock-ron', vendorId: 'curios', kind: 'character', name: 'Ron', description: 'A travelling bard whose ribbon staff sweeps foes aside. Tobias the flying tuna comes with him.', effect: 'On your roster from the start. Uses either weapon.', prices: [50], maxRank: 1, icon: 'cloak', accent: 0x1e4a3e },
  { id: 'unlock-sheldon', vendorId: 'curios', kind: 'character', name: 'Sheldon', description: 'Always up for the next trail. Frankie the buzzard circles above him.', effect: 'On your roster from the start. Uses either weapon.', prices: [50], maxRank: 1, icon: 'cloak', accent: 0xc7a86d },
  { id: 'unlock-hailey', vendorId: 'curios', kind: 'character', name: 'Hailey', description: 'An adventurous heart, with Midnight padding along beside her.', effect: 'On your roster from the start. Uses either weapon.', prices: [50], maxRank: 1, icon: 'cloak', accent: 0xa7b4eb },
...
export function marketItemBenefit(id: string, ownedRank: number): string {
  ...
  switch (item.id) {
    ...
    case 'unlock-sheldon': return 'Sheldon is on the home screen';
    case 'unlock-ron': return 'Ron is on the home screen';
    case 'unlock-hailey': return 'Hailey is on the home screen';

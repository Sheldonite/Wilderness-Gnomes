...
export type MarketItemId =
  ...
  | 'unlock-crossbow' | 'unlock-hailey' | 'honey-glow' | 'violet-glow' | 'glitter-trail' | 'ups-buddy';

export type CosmeticId = 'honey-glow' | 'violet-glow' | 'glitter-trail' | 'ups-buddy';
...
export const MARKET_ITEMS: readonly MarketItem[] = [
  ...
  { id: 'unlock-hailey', vendorId: 'curios', kind: 'character', name: 'Hailey', description: 'An adventurous heart, ready to join your roster.', effect: 'Permanent character unlock. Uses either weapon.', prices: [15], maxRank: 1, icon: 'cloak', accent: 0xa7b4eb },

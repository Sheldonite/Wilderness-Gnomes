...
export const ART = { title, ground, props, water, bridge, crossbow } as const;
export const LOOK = {
  worldPadding: 160,
  ...
  texture: { ground: 'storybook-ground', props: 'storybook-props', bolt: 'spell-bolt', acorn: 'acorn', quarrel: 'crossbow-bolt', crossbow: 'heartwood-crossbow', crystal: 'xp-crystal', spark: 'spell-spark', shadow: 'contact-shadow' }
} as const;

...
export const LOOK = {
  ...
  texture: { ground: 'storybook-ground', props: 'storybook-props', bolt: 'spell-bolt', quarrel: 'crossbow-bolt', crossbow: 'heartwood-crossbow', crossbowTop: 'heartwood-crossbow-top', crystal: 'xp-crystal', spark: 'spell-spark', shadow: 'contact-shadow' }
} as const;
